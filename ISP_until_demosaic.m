...
raw_bayer = uint16(raw_bayer*(2^10));
%raw_bayer = rot90(raw_bayer',2);
raw_bayer = raw_bayer';

%% Step 2: Black level correction & offset
% black_level = 50; %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Where does it come from?
% raw_bayer_rs_10bit = raw_bayer/2^4-black_level; % Correct: 14-bit --> 10-bit
raw_bayer_rs_10bit=raw_bayer;
...
raw_bayer_16bit = uint16(raw_bayer_rs_10bit*2^6);
